...
class ActivityDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(title.toUpperCase(), style: TextStyle(fontWeight: FontWeight.bold, letterSpacing: 1.5, fontSize: context.scaled(18))),
          ...
          children: [
            TweenAnimationBuilder(
              ...
              child: NeoCard(
                ...
                child: Column(
                  children: [
                    Text("TODAY'S PROGRESS", style: TextStyle(fontWeight: FontWeight.w900, color: Colors.grey.shade600, letterSpacing: 1.2, fontSize: context.scaled(12))),
                    32.vSpace,
                    NeoCircularProgress(
                      progress: progress,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FittedBox(
                            ...
                            child: Text(value, style: TextStyle(fontSize: context.scaled(32), fontWeight: FontWeight.bold, color: color)),
                          ),
                          Text(title, style: TextStyle(color: Colors.grey, fontWeight: FontWeight.normal, fontSize: context.scaled(14))),
                        ],
                      ),
                    ),
                    32.vSpace,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              ...
                              style: TextStyle(fontSize: context.scaled(12), color: Theme.of(context).textTheme.bodyMedium?.color),
                            ),
                          ),
                        ],
                      ),
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text("RECENT HISTORY", style: TextStyle(fontWeight: FontWeight.w900, fontSize: context.scaled(12), letterSpacing: 1.2)),
                  ),
                  16.vSpace,
            ...
            NeoButton(
              onPressed: () => Get.back(),
              child: Center(child: Text("Back to Dashboard", style: TextStyle(fontSize: context.scaled(16), fontWeight: FontWeight.bold))),
            ),
          ],
        ),
      ),
